    ...
    function get_info(scan_rabi_id) {
        if (scan_rabi_id.substr(0, 4) == "cart") {
            if ($('#lb_hello').is(':visible') === true) {
                ...
                window.location.href = 'https://140.126.146.41/fs/cbs_cd.aspx?pid=' + scan_rabi_id.substr(4, 14);
            ...
            window.location.href = 'https://140.126.146.41/fs/cbs_cd.aspx?pid=' + scan_rabi_id;
            //alert("444");
        }
